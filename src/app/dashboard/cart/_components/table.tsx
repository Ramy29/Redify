  ...
  return (
    <div className="overflow-hidden">
      <div className="container mx-auto my-4 w-full flex flex-col lg:flex-row gap-6 px-2">
        ...
        >
          <h1 className="font-semibold text-xl sm:text-2xl text-chart-3">
            Products Details
          </h1>
        ...
        >
          <div
            className="w-full rounded-xl text-chart-3 shadow-xl p-4 sm:p-6"
            style={{
              background:
                "linear-gradient(135deg, #a1c4fd 0%, #c2e9fb 100%)",
            }}
          >
            <h1 className="font-semibold text-xl sm:text-2xl border-b border-ring pb-2">
              Cart Total Cost
            </h1>
            <div className="w-full h-[1px] bg-ring"></div>
            ...
            <TableFooter className="mt-4">
              <TableRow className="border border-b-4 border-ring">
                <TableCell className="w-64 " colSpan={3}>
                  Total
                </TableCell>
                <TableCell className="text-right">
                  {cart.total} $
